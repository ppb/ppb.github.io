...
`BaseScene`. Because `ppb` doesn't have a master list of events, you can provide
...
Before getting involved, you should read our [Code of Conduct]({% link coc.md %}).
...
of our [Contributing guide]({% link contributing.md %}).
